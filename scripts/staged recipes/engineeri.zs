...
for name in createItems {
    ...
    mods.recipestages.Recipes.setRecipeStage("engineeringi", thing);
}
mods.recipestages.Recipes.setRecipeStage("engineeringi", <item:creategears:gear>);
mods.recipestages.Recipes.setRecipeStage("engineeringi", <item:creategears:large_gear>);
mods.recipestages.Recipes.setRecipeStage("engineeringi", <item:creategears:fully_encased_chain_drive>);
mods.recipestages.Recipes.setRecipeStage("engineeringi", <item:creategears:simple_gearshift>);