...
mods.jei.JEI.addInfo(<item:kubejs:brass_eye>, ["Used for researching. Requires research Engineering III"]);
mods.jei.JEI.addInfo(<item:kubejs:brass_ball>, ["Requires research Engineering III"]);
